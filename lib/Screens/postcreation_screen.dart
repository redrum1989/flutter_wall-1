        ...
        body: Stack(
          children: [
            ListView(
              children: [
                Ttiel(),
                TextController(postTitleTextController: _postTitleTextController),
                College(),
                Collegetext(),
                Writehere(),
                WiteHereText(postContentTextController: _postcontentTextController,),
                SizedBox(height: 30),
                Postbutton(postTitleTextController: _postTitleTextController, postContentTextController: _postcontentTextController,)
              ],
            ),
            Container(
              height: 70,
...
class WiteHereText extends StatelessWidget {
  const WiteHereText({
    ...
    Key key,
  }) : _postContentTextController = postContentTextController, super(key: key);
...
class TextController extends StatelessWidget {
  ...
  }) : _postTitleTextController = postTitleTextController, super(key: key);
...
class Postbutton extends StatelessWidget {
  const Postbutton({
    ...
    @required TextEditingController postTitleTextController,
    @required TextEditingController postContentTextController,
  }) : _postTitleTextController = postTitleTextController, _postContentTextController = postContentTextController, super(key: key);
